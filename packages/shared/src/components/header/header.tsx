        ...
        observer(
            ...
            > {
                    ...
                    this.setState(
                        ...
                        () =>
                            (this.props.rootStore
                                .orderStore as OrderStore).setNumOrdersToCreate(
                                event.target.value
                            )
                    );
                }
                ...
                onVisibilitySelectorChange(value: string) {
                    this.setState({ visibilitySelector: value }, () =>
                        (this.props.rootStore
                            .orderStore as OrderStore).setFilter(
                            value as VisibilityFilterEnum
                        )
                    );
                }
                ...
                createNewOrders() {
                    return (this.props.rootStore
                        .orderStore as OrderStore).createOrdersAtServer(
                        ...
                        <AppBar position="static" color="default">
                            <Toolbar className={classes.toolbar}>
                                ...
                                <VisibilitySelector
                                    ...
                                    value={this.state.visibilitySelector}
                                    onChange={this.onVisibilitySelectorChange.bind(
                                        this
                                    )}
                                    onReset={this.resetOrders.bind(this)}
                                />
                                <TextField
                                    id="numOrdersToCreate"
                                    className={classes.numOrdersToCreate}
                                    type="number"
                                    value={this.state.numOrdersToCreate}
                                    onChange={this.onNumOrdersToCreateChange.bind(
                                        this
                                    )}
                                />
                                <Button
                                    ...
                                    onClick={this.createNewOrders.bind(this)}
                                >
                                    New Order
                                </Button>
                                <Chip
                                    label={orderStore.count}
