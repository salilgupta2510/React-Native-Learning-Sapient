...
export const OrderView = decorate<OrderViewProps>(
    class extends React.Component<OrderViewProps & WithStyles<
        | 'tableRow'
        | 'quantity'
        | 'fontStyle'
        | 'symbol'
        ...
        constructor(props: any) {
            ...
            this.quantityClass = `${props.classes.quantity} ${props.classes.fontStyle}`;
            this.symbolClass = `${props.classes.symbol} ${props.classes.fontStyle}`;
        }
        ...
        render() {
            ...
            return <TableRow className={classes.tableRow}>
                <TableCell
                    className={
                        order.side === 'BUY' ? classes.buyStyle : classes.sellStyle
                    }
                >
                    {order.side}
                </TableCell>
