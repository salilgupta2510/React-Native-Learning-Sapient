...
export const VisibilitySelector = decorate<VisibilityProps>(
    class extends React.Component<VisibilityProps & WithStyles<'headerControls' | 'checked' | 'headerButton'>> {
        ...
        handleChange = (event: React.ChangeEvent<any>): void => {
            event.persist();
            this.setState({ selectedValue: event.target.value }, () => this.props.onChange && this.props.onChange(event.target.value));
        };
        ...
        render() {
            ...
            return (
                <div className={classes.headerControls}>
                    ...
                    <Button className={classes.headerButton} onClick={onReset}>Reset</Button>
                </div>
            );
        }
    }
